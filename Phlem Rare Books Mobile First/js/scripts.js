...
function getPostDetails() {
    ...
    for (var i = 0; i < productsArray.length; i++) {
        ...
        leftColCard.innerHTML += "<button class='favoriteButton' value='" + i + "' onclick='addToFavorites(this)'><i class='fas fa-thumbs-up'></i> Add to Favorites</button>";
        leftColCard.innerHTML += " <button class='buyButton' value='" + i + "' onclick='openForm(this); this.disabled=true;'><i class='fas fa-credit-card'></i> Buy Book</button>";
    }
}
...
//Buy Book when button is clicked, passed global object that contains the current clicked button
function buyBook(object) {
    currentButtonObject.innerHTML = "Bought!!";
}
...
// Handle hiding/showing of the checkout form
function openForm(object) {
    currentButtonObject = object;
